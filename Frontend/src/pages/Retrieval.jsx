          ...
          {searchResults.found ? (
            <>
              <div className="item-details">
                <h2>Item Found</h2>
                <p>
                  <strong>Name:</strong> {searchResults.item.name}
                </p>
                <p>
                  <strong>ID:</strong> {searchResults.item.item_id}
                </p>
                <p>
                  <strong>Priority:</strong> {searchResults.item.priority}
                </p>
                <p>
                  <strong>Current Zone:</strong>{" "}
                  {searchResults.item.current_zone}
                </p>
                {searchResults.item.usage_limit !== null && (
                  <p>
                    <strong>Remaining Uses:</strong>{" "}
                    {searchResults.item.usage_limit}
                  </p>
                )}
              ...
              {placement && (
                <div className="placement-details">
                  ...
                  <p>
                    <strong>Container:</strong> {placement.container_id}
                  </p>
                  <p>
                    <strong>Zone:</strong> {placement.zone}
                  </p>
                  <p>
                    <strong>Retrieval Steps:</strong>{" "}
                    {searchResults.retrievalSteps}
                  </p>
